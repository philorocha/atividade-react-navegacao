            ...
            <View>
                <View>
                    <List.Item
                        ...
                        left={avatar => <Avatar.Image size={90} source={{ uri: props.avatar }} />}
                        onPress={() => navigation.navigate('Editar Contato', {name: props.name, phone: props.phone})}
                    />
                    <Divider />
                </View>
            </View>
        ...
        <View>
            {
                contacts.map((contact, i) => (
                    <Contact name={contact.name} phone={contact.phone} avatar={contact.avatar} key={i} />
                ))
            }
        </View>
    );
